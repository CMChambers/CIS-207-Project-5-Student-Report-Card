...
namespace CIS_207_Project_5_Student_Report_Card
{
    ...
    {
        public static ValidationResultInt ValidateInt(string _number)                                   // returns a validation result for an int
        {
            ...
            { return new ValidationResultInt("Please enter a number for the score", "Missing Score"); } // returns a validation result containing error information

            return new ValidationResultInt(convertedNumber);                                            // return validated result containing int and no-error falg
        }

        internal static ValidationResultString ValidateString(string _string)                           // returns a validation result for a string
        {
